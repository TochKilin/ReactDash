...
import {Space,Input,Button,List,Table,message, Modal, Tag, Form, Select, notification, Spin} from 'antd';
...
function RolePage() {
    ...
    const getList = async () => {
        ...
        // send to api  localhost:8000/api/role?page1&text_search=admin form is query parameter
    ...
    <div>
        ...
        <div className="main-page-header"> 
            <Space>  
                ...
                <Input.Search onChange={(e) => setFilter(p => ({...p,text_search:e.target.value}))} allowClear placeholder="Search"/>
                <Select
                allowClear={true}
        ...
        >
           <Form layout="vertical" onFinish={onFinish} form={formRef}>
                ...
                <Form.Item name={"code"} label="Role code" {...validate.code}
                    rules={[
                        {
                            required:true,
                ...
                <Form.Item name={"description"} label="Description" {...validate.description}>
